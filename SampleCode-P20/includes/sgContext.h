...
namespace API2
{
  ...
  class SGContext
  {
    public:
       ...
       * 				[ExchangName] [SYMBOL] [Expiry1(YYYYMMDD)] [Expiry2(YYYYMMDD)]
       * 				Example:
       * 				NSE RELIANCE 20151126 20151231
       *
       * @param regMktData set True to register for Market Data for the Instrument
       * @param useSnapShot Set True if Snapshot Feed is to be used
       * @param useTbt Set True to use TBT-Feed
      ...
      bool reqNewSingleOrder(DATA_TYPES::RiskStatus &riskStatus,
          ...
          const DATA_TYPES::OrderPriority &orderPriority = CONSTANTS::CMD_OrderPriority_MaxPriority);
       ...
       * 				NSE RELIANCE 20151126 20151231
       * 				For Indices
       * 				[ExchangeName] [IndexSymbolName]
       * 				Example:
       * 				NSE CNX Nifty, NSE BANK Nifty
       *
       * @param isSnapshot
       * @param isTbt
      ...
      bool reqQryCMDDisconnection( const DATA_TYPES::CommandCategory &command,
          DATA_TYPES::StrategyComment strategyComment );

...
#include "../../includes/api_includes/api2RequestResponse.h"
#include "../../includes/api_includes/sharedResponse.h"
#include "../../includes/api_includes/api2UserCommands.h"
#else
...
public:
    ...
    virtual void onLoadOldStrategiesOptimized(){}
    ...
    virtual void setEnableWidget(const QString &widgetName, bool enable){};
    ...
    virtual qlonglong getSpotIndexSymbolId(const QString &market,
                                           const QString &symbol){ return 0; }
    ...
    virtual qlonglong getUnderlyingFutSymbolId(qlonglong symbolId,
                                               bool isDeltaUnderlying = false){ return 0; }
    ...
    virtual void registerProxyModelOnBook(QSortFilterProxyModel* proxyModel, int bookType = -1) {}

    virtual bool isArchiveData()
    {
        return false;
    }

    virtual void setFilterOnBooks(const QString& regexp, const QString& filterColumn = "",
                                  int bookType = -1, bool isClearAll = false)
    {}
...
public slots:
    ...
    /**
     * @brief isPortfolioNameUnique
     * Overload this function to validate uniqueness of given portfolio name
     * @param portfolioName
     * @return
     */
    virtual bool isPortfolioNameUnique(const QString &portfolioName)
    {
        return true;
    }
...
public:
    ...
    virtual bool updateStrategyDefaultValuesBatch(const QVariantList& adminTokenIdNewList){ return false; }
    ...
    virtual void populateIvUnderlying(const qlonglong &symbolId,int count){}
    ...
    virtual void onItemClicked(int row, int col){}
    virtual void onRowClickedNotifier(int rowClicked){}
    virtual void onCurrentRowChanged(int newRow, int oldRow) {}
    ...
    virtual short getHedgingLeg()
    {
        return API2::LEG_MAX;
    }


    virtual qlonglong getSymbolIdFromStrategyId(qlonglong strategyId) {return 0;}

    virtual bool disableStrategyRunCheckBox()
    {
        return false;
    }
...
public:
    ...
    virtual short getGenericStrategyType(const QString &threeLegStrategy,short leg){ return -1; }
    ...
    virtual short getLegType(const QString &str){ return -1; }
    ...
    virtual QString getInstrumentTypeFromName(const QString &instrument){ return ""; }

    virtual QString getTwoLegArbitHedgeMethod(short hedgeMethod){ return ""; }


    virtual short getTwoLegArbitHedgeMethod(const QString &hedgeMethod){ return -1; }
    ...
    virtual double getVegaPrice( qlonglong symbolId,
                                 qlonglong bidPriceVal,
                                 short orderMode,
                                 qlonglong underlyingSymbolId)
    {
        return 0.0f;
    ...
    virtual bool isuHedgePidValid(const QString &portfolioName)
    {
        return false;
    }

    virtual QString getSymbolDetailKey(qlonglong symbolId)
    {
        return QString();
    }

    virtual const API2::SymbolDetail& getSymbolIdDetail(const QString& symbolKey)
    {
        return API2::SymbolDetail();
    }

    virtual bool isInterExchange()
    {
        return false;
    }

    virtual bool isNSEMarket(const QString& market)
    {
        return false;
    }

    virtual bool isNSEMarket(short exchangeId)
    {
        return false;
    }

    virtual short getExchangeGroup(const QString& market)
    {
        return -1;
    }

    virtual short getExchangeGroup(short exchangeId)
    {
        return -1;
    }

    /**
     * @brief getCustomMktDataQuote
     * @param symbolId
     * @param customQuote
     * Use this function to get
     * 1. Open , High , Low , Close Price Values
     * 2. Open Interest
     * 3. Last Traded Time - in epoch need to convert it accordingly
     * 4. Last Traded Quantity
     * 5. Bid-ask values with Number of Orders
     */
    virtual void getCustomMktDataQuote(qlonglong symbolId , CustomMDQuote & customQuote) { }

...
class SpreadOrder : public SingleOrder{
...
protected:
  ...
  /**
       * @brief _expiryDate
       */
  CREATE_FIELD(DATA_TYPES::EXPIRY_DATE, ExpiryDate1);
  CREATE_FIELD(DATA_TYPES::SYMBOL_ID, SymbolId1);
  CREATE_FIELD(DATA_TYPES::SYMBOL_ID, SymbolId2);

public:

  SpreadOrder();
  SpreadOrder(DATA_TYPES::SYMBOL_ID symbolId,
              DATA_TYPES::SYMBOL_ID symbolId1,
              DATA_TYPES::SYMBOL_ID symbolId2,
              SymbolStaticData &staticData,
              DATA_TYPES::CLIENT_ID clientId,
              DATA_TYPES::QTY quantity,
              DATA_TYPES::QTY disclosedQuantity,
              DATA_TYPES::PRICE price, // Limit, Market, Stop, Stop Limit
              DATA_TYPES::PRICE stopPrice, // Intraday, Delivery
              DATA_TYPES::OrderType type, // Buy, Sell
              DATA_TYPES::ProductType product, // GTD, FOK etc.
              DATA_TYPES::OrderMode mode,
              DATA_TYPES::OrderValidity validity,
              DATA_TYPES::TRADER_ID traderId,
              const AccountDetail &accountDetails=AccountDetail()
      );
  void initialize(DATA_TYPES::SYMBOL_ID symbolId,
                  DATA_TYPES::SYMBOL_ID symbolId1,
                  DATA_TYPES::SYMBOL_ID symbolId2,
                  SymbolStaticData &staticData,
                  DATA_TYPES::CLIENT_ID clientId,
  ...
  //    void setSymbolId1(const DATA_TYPES::SYMBOL_ID &symbolId);
  //    void setExpiryDate1(const DATA_TYPES::EXPIRY_DATE &);

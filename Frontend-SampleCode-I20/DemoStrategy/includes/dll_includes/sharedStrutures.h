...
#include "../../includes/api_includes/apiConstants.h"
#include "../../includes/api_includes/apiDataTypes.h"
...
public :
    ...
    public :
        ...
        MarketDepth()
            : _bidPrice( 0 ), _bidQty( 0 ),
              _noOfBids( 0 ), _askPrice( 0 ),
              _askQty( 0 ), _noOfAsks( 0 )
        {
        }
    };

    qlonglong _securityId ;
    qlonglong _lastTradeQty ;
    qlonglong _lastTradeTime ;
    qlonglong _openPrice ;
    qlonglong _closePrice ;
    qlonglong _highPrice ;
    qlonglong _lowPrice ;
    qlonglong _openInterestQty ;
    qlonglong _openInterestValue ;
    qlonglong _openInterestChange ;
    struct MarketDepth _marketDepth[5];

    CustomMDQuote() :
        _securityId( 0 ), _lastTradeQty( 0 ), _lastTradeTime( 0 ),
        _openPrice( 0 ), _closePrice( 0 ), _highPrice( 0 ), _lowPrice( 0 ),
        _openInterestQty( 0 ), _openInterestValue( 0 ), _openInterestChange( 0 )
    {}
};

...
namespace API2
{
  namespace CONSTANTS
  {
    ...
    /**
     * @brief RSP_OrderStatus_MOVE_POSITION_TO_DEFAULT strategy order moved to manual order.
     */
    const unsigned short RSP_OrderStatus_CONVERTED_ORDER_STRATEGY_TO_MANUAL = 37;

    /**
     * @brief RSP_OrderStatus_MAX
     */
   ...
   /**
    ...
    /**
     * @brief RSP_StrategyComment_MAX
     */
    const unsigned short RSP_StrategyComment_MAX = 69;
    ...
    const unsigned short CMD_ExchangeId_MAX = 83;
    ...
    const uint64_t SECONDS_TO_NANOSECONDS = 1000000;
     ...
     ************************************************************************************************************/
    /**
     * @brief RSP_TerminateReasonType_AUTO
     */
    const unsigned short RSP_TerminateReasonType_AUTO = 0;

    /**
     * @brief RSP_TerminateReasonType_FRONT_END
     */
    const unsigned short RSP_TerminateReasonType_FRONT_END = 1;

    /**
     * @brief RSP_TerminateReasonType_DMS_DISCONNECTION
     */
    const unsigned short RSP_TerminateReasonType_DMS_DISCONNECTION = 2;

    /**
     * @brief RSP_TerminateReasonType_EXCHANGE_DISCONNECTION
     */
    const unsigned short RSP_TerminateReasonType_EXCHANGE_DISCONNECTION = 3;

    /**
     * @brief RSP_TerminateReasonType_MAX
     */
    const unsigned short RSP_TerminateReasonType_MAX = 4;
  }
}
#endif

...
namespace API2
{
  namespace CONSTANTS
  {
    ...
    /** 
     * * @brief RSP_StrategyComment_ORMS_DISCONNECTED
     */
    const unsigned short RSP_StrategyComment_ORMS_DISCONNECTED = 54;

    /**
     * @brief RSP_StrategyComment_STOP_LOSS_TRIGGERED_STRATEGY_COMPLETED_UNSUCCESSFULLY
     */
    const unsigned short RSP_StrategyComment_STOP_LOSS_TRIGGERED_STRATEGY_COMPLETED_UNSUCCESSFULLY =55;
    /**
     * @brief RSP_StrategyComment_REJECTION_COUNTER_BREACHED
     */
    const unsigned short RSP_StrategyComment_REJECTION_COUNTER_BREACHED =56;
    ...
    /**
     * @brief RSP_RiskStatus_THROTTLE_LIMIT_BREACHED
     */
    const unsigned short RSP_RiskStatus_THROTTLE_LIMIT_BREACHED = 32;
    
    /**
     * @brief RSP_RiskStatus_ORMS_DISCONNECTED
     */
    const unsigned short RSP_RiskStatus_ORMS_DISCONNECTED = 33;

    /**
     * @brief RSP_RiskStatus_MAX
     */
    const unsigned short RSP_RiskStatus_MAX = 34; // = 34
     ...
     * */ 
    const short RSP_ErrorCode_TRADE_EXECUTION_RANGE = 17070;
    /**
     * @brief RSP_ErrorCode_SELF_TRADE Error Code For NSEFO
     * */ 
    const unsigned short RSP_ErrorCode_SELF_TRADE_FO = 17071;
    /**
     * @brief RSP_ErrorCode_SELF_TRADE Error Code For NSECM
     * */ 
    const unsigned short RSP_ErrorCode_SELF_TRADE_CM = 17080;
    /**
     * @brief RSP_ErrorCode_NO_TAKE_ORDERS For BSE
     * */
    const unsigned short RSP_ErrorCode_NO_TAKE_ORDERS_BSE = 210;
    /**
     * @brief RSP_ErrorCode_SELF_TRADE Error Code For BSECM
     * */
    const unsigned short RSP_ErrorCode_SELF_TRADE_BSECM = 246;
    /**
     * @brief RSP_ErrorCode_TRADE_REVERSAL Error Code For BSECM
     * */ 
    const unsigned short RSP_ErrorCode_TRADE_REVERSAL_BSECM = 247;
    /**
     * @brief RSP_ErrorCode_ORDER_DOES_NOT_EXIST For NSE
     * */ 
    const unsigned short RSP_ErrorCode_ORDER_DOES_NOT_EXIST_NSE = 16273;
    /**
    ...
    /**
     * @brief CMD_OrderPriority_NoPriority
     */
    const unsigned short CMD_OrderPriority_NoPriority = 0;

    /**
     * @brief OrderPriority_LowPriority
     */
    const unsigned short CMD_OrderPriority_LowPriority = 1;

    /**
     * @brief CMD_OrderPriority_HighPriority
     */
    const unsigned short CMD_OrderPriority_HighPriority = 2;

    /**
     * @brief CMD_OrderPriority_MaxPriority
     */
    const unsigned short CMD_OrderPriority_MaxPriority = 3;
